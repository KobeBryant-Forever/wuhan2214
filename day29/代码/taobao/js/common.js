// 接口的基础地址
const apiBaseUrl = 'http://shopapi.phpclub.org.cn/home/';
...
function $$(selector, isOne = true) {
    return isOne ? document.querySelector(selector) : document.querySelectorAll(selector);
}
/**
 * 发送Ajax请求
